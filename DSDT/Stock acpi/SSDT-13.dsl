 ...
 *
 * Disassembly of SSDT-13.aml, Sun Sep 17 00:56:37 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001A93 (6803)
 *     Revision         0x01
 *     Checksum         0xD2
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.RP01.CEDR, FieldUnitObj)
    External (_SB_.PCI0.RP01.DGCX, IntObj)
    External (_SB_.PCI0.RP01.LNKD, FieldUnitObj)
    External (_SB_.PCI0.RP01.LNKS, FieldUnitObj)
    External (_SB_.PCI0.RP01.LREN, FieldUnitObj)
    External (_SB_.PCI0.RP01.PEGP, DeviceObj)
    External (_SB_.PCI0.RP01.PEGP.HGOF, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.RP01.PEGP.HGON, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.RP01.PEGP.LTRE, IntObj)
    External (_SB_.PCI0.RP01.PEGP.SGPO, MethodObj)    // 4 Arguments
    External (_SB_.PCI0.RP01.PEGP.SGST, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.RP01.TDGC, IntObj)
    External (_SB_.PCI0.RP01.TGPC, BuffObj)
    ...
    Scope (\_SB.PCI0.RP01.PEGP)
    {
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            \_SB.PCI0.RP01.PEGP.SGPO (Zero, 0x02010014, Zero, One)
            While (LNotEqual (\_SB.GGIV (0x02010015), Zero))
            {
                Sleep (One)
            }

            \_SB.PCI0.RP01.PEGP.SGPO (Zero, 0x02010014, Zero, Zero)
